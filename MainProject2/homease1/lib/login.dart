...
import 'package:homease1/widget/button.dart';
import 'package:homease1/widget/custom_checkbox.dart';
import 'package:homease1/widget/textfield.dart';
  ...
  Future<void> login() async {
    if (isCheckBox == true) {
      ...
      ScaffoldMessenger.of(context)
        ..hideCurrentSnackBar()
        ..showSnackBar(const SnackBar(content: Text("Selected the check box")));
    }
  }
